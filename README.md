...
> **Future Work:** Add support for strings,pointers and arrays. Build a backend assembler that maps assembly mnemonics to their binary opcodes, producing executable machine code for the target processor.
---
